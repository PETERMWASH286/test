...
class EnterpriseMechanicScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const double annualPrice = 30000.0; // Annual price for enterprise
    const double monthlyPrice = 3500.0; // Monthly price for enterprise
                ...
                children: [
                  ...
                  buildPackageCard(
                    ...
                    description:
                        ...
                        '• CEO Company Profiling.\n'
                        '• Connection with Car Owners.\n'
  ...
  Future<void> _submitPaymentData(String email, String amount, String subscriptionType, String phoneNumber, BuildContext context) async {
    ...
    try {
      ...
      SharedPreferences prefs = await SharedPreferences.getInstance();
      await prefs.setString('user_role', 'enterprise_mechanic');  // Save the role as 'car_owner'
          ...
          showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                ...
                content: Text('Your payment of Ksh $amount for $subscriptionType subscription was successful!'),
                actions: [
                  TextButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const EnterpriseHomeScreen(),
                        ),
                      );
                    },
                    child: const Text('OK'),
